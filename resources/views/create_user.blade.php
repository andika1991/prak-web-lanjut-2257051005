    ...
    <form action="{{ route('user.store') }}" method="POST" class="bg-white p-8 rounded-lg shadow-lg w-full max-w-md relative">
        ...
        <div class="mb-6">
            ...
            <div class="flex items-center border border-gray-300 rounded-lg focus-within:ring-2 focus-within:ring-purple-500">
                ...
                <input type="text" id="nama" name="nama" class="w-full px-3 py-2 focus:outline-none rounded-r-lg" placeholder="Masukkan nama ">
            </div>
        </div>
        ...
        <div class="mb-6">
            ...
            <div class="flex items-center border border-gray-300 rounded-lg focus-within:ring-2 focus-within:ring-purple-500">
                ...
                <input type="text" id="npm" name="npm" class="w-full px-3 py-2 focus:outline-none rounded-r-lg" placeholder="Masukkan NPM">
            </div>
        </div>
        ...
        <div class="mb-6">
            ...
            <div class="flex items-center border border-gray-300 rounded-lg focus-within:ring-2 focus-within:ring-purple-500">
                ...
                <input type="text" id="kelas" name="kelas" class="w-full px-3 py-2 focus:outline-none rounded-r-lg" placeholder="Masukkan kelas">
            </div>
        </div>
